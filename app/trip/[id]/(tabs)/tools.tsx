...
export default function Tools() {
  ...
  return <View style={s.screen}><ScreenHeader title="여행 도구" back={false} />{trip ? <TravelTools key={trip.id + trip.currency} trip={trip} /> : <Text style={s.body}>여행을 찾을 수 없어요.</Text>}</View>;
}
