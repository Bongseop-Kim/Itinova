...
| 13 | `13-home-hero-scenes.md` | S01 홈 C2 — 히어로 씬 + 가로 캐러셀, 도시 씬 에셋 48장 슬롯·폴백 | 없음 (에셋 6개 도시 세트가 실행 조건) | 도시 씬 이미지 생성(사용자) |
...
13(홈 히어로 씬)은 2026-09-17에 추가했고 다른 플랜과 독립이다 — 도시 씬 에셋이 준비되는 즉시 언제든 끼워 넣는다.
...
- [ ] S01 홈이 도시 씬 히어로 + 가로 캐러셀로 서고, 진행중 없음·여행 0건 분기가 모두 성립한다(13).
