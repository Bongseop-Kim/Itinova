...
| S02 | `/settings` | 앱 설정 | AI 구독 상태·관리·구매 복원, 언어, 날짜·거리 형식, 기본 통화, 위치 권한, 알림, 전체 데이터 내보내기/가져오기 | 구독 행 → S23 또는 스토어 구독 관리 | `38`, app-01 `73` |
...
| S02 설정 | 백업/가져오기·앱 정보 | 날짜/거리 형식·기본 통화·알림 설정 미구현. GPS 기능을 쓰지 않아 위치 권한 요청 없음 |
